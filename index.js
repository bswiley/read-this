...
if (tests){
 ...
 fs.appendFile('./README.md', `\n## Questions\n${questions ?`${questions}`:""}${github ?`This project can be accesed at [github.com/${github}/${title}](https://github.com/${github}/${title}).  `:""}${email ?`If you have questions, please email me at ${email}.`:""}`, err =>
 err ? console.error(err): console.log (""));}
